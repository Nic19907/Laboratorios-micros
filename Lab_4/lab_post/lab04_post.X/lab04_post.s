...
PSECT udata_bank0
    cont:	;contador de ciclos tmr0
	DS 2
    
    ;display 7 segmentos S
    conteo_1:
	DS 1
    ;display 7 segmentos deca S
    conteo_2:
	DS 1
...
; TABLAS
;-------------------------------------------------------------------------------
ORG 0x0100  ;estar pendiente puede variar
tabla:
    clrf    PCLATH
...
config_io:
    ...
    clrf    TRISC   ;contador 4 bits 1000ms
    clrf    TRISD   ;7 segmentos incrementa cada 1000ms  

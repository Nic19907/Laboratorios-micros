...
config_clock:
    ...
    bsf ((OSCCON) and 07Fh), 5 ;0
    bcf ((OSCCON) and 07Fh), 4 ;0 oscilador a 1MHz
...
config_int_enable:
    ...
    bsf ((INTCON) and 07Fh), 3 ;PORTB pueden cambiar interrupciones
    bcf ((INTCON) and 07Fh), 0
...
config_tmr0:
    ...
    bcf ((OPTION_REG) and 07Fh), 1 ;0
    bsf ((OPTION_REG) and 07Fh), 0 ;1 101, escala de 1:32
    return

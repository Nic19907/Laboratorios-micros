...
;-------------------------------------------------------------------------------
;transistor 0 =decenas,  01
;transistor 1 =unidades, 10
...
config_io:
    ...
    banksel	TRISA
    clrf    TRISA   ;puerto A para ensenar el contador del tmr1
    bcf	    TRISB,0 ;led intermitente
    clrf    TRISC   ;7 segmentos decimales y unidades
    bcf	    TRISD,0 ;transistor 0
    bcf	    TRISD,1 ;transistor 1
...
preparar_display7_dec:
    ...
    call    tabla_7seg
    movwf   display7_dec    ;decenas
    
    movf    resultado_div+1, w
    call    tabla_7seg
    movwf   display7_dec+1  ;unidades
    return

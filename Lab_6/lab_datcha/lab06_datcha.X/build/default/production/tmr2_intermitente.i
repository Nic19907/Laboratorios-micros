# 1 "tmr2_intermitente.s"
# 1 "<built-in>" 1
# 1 "tmr2_intermitente.s" 2
...
config_tmr2: ;se le pone el valor al que el contador debe llegar
    ...
    bcf ((T2CON) and 07Fh), 5 ;0
    bcf ((T2CON) and 07Fh), 4 ;0
    bsf ((T2CON) and 07Fh), 3 ;1, 1001 Postscaler 1:10

    bsf ((T2CON) and 07Fh), 2 ;encender el tmr2

    bcf ((T2CON) and 07Fh), 1 ;0
    bsf ((T2CON) and 07Fh), 0 ;1, 01 prescaler 1:4
    restart_tmr2
    return
